...
from .views import UserHasService,ServicePromotion,AllServiceInPromotion, ServiceList, ServiceView, JobView, ReviewView, UserServiceList, ProfessionList, AllProfessionList
app_name = 'service'
