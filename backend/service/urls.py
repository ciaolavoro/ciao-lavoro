...
from .views import PromotionPayment, MostRatedServices, PromoteService, IsReviewService
app_name = 'service'
...
urlpatterns = [
    ...
    path('<int:service_id>/review/', IsReviewService.as_view(), name= 'service-promote'),
]