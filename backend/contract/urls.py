...
from .views import ContractCreation, ContractEdit, ContractStatusEdit, ContractDelete, ContractList, ContractDetail
...
urlpatterns = [
    ...
    path('list/', ContractList.as_view(), name="user-contracts"),
