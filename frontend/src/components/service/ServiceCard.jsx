...
export default function Service({ service }) {
  ...
  return (
    <div className="w-80 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
      ...
      <img 
        src={service.user.image ? `${BACKEND_URL}${service.user.image}` : "https://images.unsplash.com/photo-1646753522408-077ef9839300?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NjZ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"} 
        ...
        <div className="px-4 py-3 w-72">
          ...
          <p className="mb-2"><strong>Idioma:</strong> {service.user && service.user.language ? service.user.language : "Sin idioma"}</p>
