...
**Yo, Antonio Barea Jiménez, perteneciente al grupo 6 de la asignatura, me comprometo de manera voluntaria y consciente a cumplir con las siguientes cláusulas y responsabilidades durante mi participación en la asignatura ISPP para el curso académico 2023-24.**
...
- Filtrar feedback de Usuarios Piloto
- Realizar la funcion de Project Manager del grupo.
- Realizar el formulario de usuarios piloto
- Hacer de usuario piloto para el grupo 12
- Ver la theory pill Market segmentation, traction and community management



-----
**Firma del Alumno: ![firma](./ImágenesFirma/firmaAntonio.png)**
